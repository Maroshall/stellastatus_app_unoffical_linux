...
(function () {
  ...
  const STR = {
    ko: {
      ...
      'changelog.error': '업데이트 기록을 불러오지 못했어요.', 'changelog.now': '현재',
    },
    ...
    en: {
      ...
      'changelog.error': 'Couldn’t load the changelog.', 'changelog.now': 'Current',
    },
    ...
    ja: {
      ...
      'changelog.error': '更新履歴を取得できませんでした。', 'changelog.now': '現在',
    },
  };
