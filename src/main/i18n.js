...
const STR = {
  ko: {
    ...
    'notify.offTitle': '⚫ {name} 님이 방송을 종료했어요',
    'notify.offBody': '오늘도 수고하셨어요!',
  ...
  en: {
    ...
    'notify.offTitle': '⚫ {name} ended their stream',
    'notify.offBody': 'Thanks for watching!',
  ...
  ja: {
    ...
    'notify.offTitle': '⚫ {name} が配信を終了しました',
    'notify.offBody': 'お疲れさまでした！',
